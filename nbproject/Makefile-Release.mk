...
${OBJECTDIR}/sources/Arch/Windows/DllMain.o: sources/Arch/Windows/DllMain.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -Iincludes -std=c++98  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/Arch/Windows/DllMain.o sources/Arch/Windows/DllMain.cpp
...
${OBJECTDIR}/sources/Core/Memory.o: sources/Core/Memory.cpp
	${MKDIR} -p ${OBJECTDIR}/sources/Core
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -Iincludes -std=c++98  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/Core/Memory.o sources/Core/Memory.cpp

${OBJECTDIR}/sources/Core/NullPointerException.o: sources/Core/NullPointerException.cpp
	${MKDIR} -p ${OBJECTDIR}/sources/Core
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -Iincludes -std=c++98  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/Core/NullPointerException.o sources/Core/NullPointerException.cpp
...
${OBJECTDIR}/sources/Core/ReferenceCounted.o: sources/Core/ReferenceCounted.cpp
	${MKDIR} -p ${OBJECTDIR}/sources/Core
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -Iincludes -std=c++98  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/Core/ReferenceCounted.o sources/Core/ReferenceCounted.cpp

${OBJECTDIR}/sources/Core/String.o: sources/Core/String.cpp
	${MKDIR} -p ${OBJECTDIR}/sources/Core
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -Iincludes -std=c++98  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/Core/String.o sources/Core/String.cpp
...
${TESTDIR}/tests/axf/core/memory/smart_references.o: tests/axf/core/memory/smart_references.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -Werror -Iincludes -I. -std=c++98 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/axf/core/memory/smart_references.o tests/axf/core/memory/smart_references.cpp
...
${OBJECTDIR}/sources/Arch/Windows/DllMain_nomain.o: ${OBJECTDIR}/sources/Arch/Windows/DllMain.o sources/Arch/Windows/DllMain.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Werror -Iincludes -std=c++98  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/Arch/Windows/DllMain_nomain.o sources/Arch/Windows/DllMain.cpp;\
	else  \
...
${OBJECTDIR}/sources/Core/Memory_nomain.o: ${OBJECTDIR}/sources/Core/Memory.o sources/Core/Memory.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Werror -Iincludes -std=c++98  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/Core/Memory_nomain.o sources/Core/Memory.cpp;\
	else  \
...
${OBJECTDIR}/sources/Core/NullPointerException_nomain.o: ${OBJECTDIR}/sources/Core/NullPointerException.o sources/Core/NullPointerException.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Werror -Iincludes -std=c++98  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/Core/NullPointerException_nomain.o sources/Core/NullPointerException.cpp;\
	else  \
...
${OBJECTDIR}/sources/Core/Object_nomain.o: ${OBJECTDIR}/sources/Core/Object.o sources/Core/Object.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Werror -Iincludes -std=c++98  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/Core/Object_nomain.o sources/Core/Object.cpp;\
	else  \
...
${OBJECTDIR}/sources/Core/ReferenceCounted_nomain.o: ${OBJECTDIR}/sources/Core/ReferenceCounted.o sources/Core/ReferenceCounted.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Werror -Iincludes -std=c++98  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/Core/ReferenceCounted_nomain.o sources/Core/ReferenceCounted.cpp;\
	else  \
...
${OBJECTDIR}/sources/Core/String_nomain.o: ${OBJECTDIR}/sources/Core/String.o sources/Core/String.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Werror -Iincludes -std=c++98  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sources/Core/String_nomain.o sources/Core/String.cpp;\
	else  \
